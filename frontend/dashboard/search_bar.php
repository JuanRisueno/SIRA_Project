...
<div class="search-container" style="margin-bottom: 2rem;">
    <form action="dashboard.php" method="GET" class="search-box">
        ...
        <?php if ($busqueda): ?>
            <a href="dashboard.php<?= ($vista_actual === 'gestion_localidades') ? '?seccion=localidades' : '' ?>" class="card-btn" style="margin-top:0; width:auto; border-radius: 8px; font-size: 0.8rem; padding: 0.5rem 1rem; background: var(--color-bg-input); border: 1px solid var(--border-color); color: var(--color-text-main);">Limpiar</a>
        <?php endif; ?>
    </form>
</div>
<?php endif; ?>
